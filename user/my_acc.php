       ...
       <div class="box-2">
            ...
            <ul id="account_det">
                <?php
                    ...
                    $c_user = $_SESSION['USER_NAME'];
                                
                    $get_img = "select * from users where u_email='$c_user'";
            ...
            <ul>
                ...
                <?php
                  if(isset($_SESSION['USER_NAME'])){
                    ...
                    $get_det = "select * from users where u_email='$c_user'";
                                
                    $run_det = mysqli_query($con, $get_det);
                                
                    $row_det = mysqli_fetch_array($run_det);
                                
                    $c_name = $row_det['u_name']; 
