...
<body>
    ...
    <form class="login-content" method="post" action="#">
        <h1 class="head-login">USER LOGIN</h1>
        <label class="left"><b>Email</b></label>  <input type="text" placeholder="Enter your User Name" id='user' name="user" required>
...
$sel_user = "select * from users where u_email='$uname' AND u_pass='$pass'";
